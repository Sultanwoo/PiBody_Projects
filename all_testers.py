...
led_tester = LedTester(alll)
touch_tester = TouchTester(alll) # touch, button and motion are one
button_tester = ButtonTester(alll)
motion_tester = MotionTester(alll)
...
test_list = [led_tester, motion_tester, servo_tester, touch_tester, potentiometer_tester, encoder_tester, sound_tester, climate_tester, gyro_tester]
